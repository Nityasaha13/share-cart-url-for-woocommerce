...
if ( ! class_exists( 'SCURL_Share_Cart_URL' ) ) {
    ...
    class SCURL_Share_Cart_URL {
        ...
        public static function scurl_ajax_email_cart() {
            ...
            if ( '' !== $message ) {
                $body .= '<p>Message: ' . nl2br( esc_html( $message ) ) . '</p>';
            }
            $body .= '<p><a href="' . esc_url( $share_url ) . '" style="display:inline-block;background-color:#2271b1;color:#ffffff;padding:12px 24px;text-decoration:none;border-radius:3px;font-weight:600;">' . esc_html__( 'View your cart', 'share-cart-for-woocommerce' ) . '</a></p>';
            $body .= '<p style="word-break:break-all;font-size:12px;color:#666666;margin-top:-8px;">Link: ' . esc_html( $share_url ) . '</p>';
